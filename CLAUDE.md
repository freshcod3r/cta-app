...
- [~] First EAS Build run produces both `.ipa` AND `.aab` artifacts:
      - [x] `.aab` -- Android preview build queued at
            <https://expo.dev/accounts/freshcod3r/projects/cta-app/builds/a280e094-957f-491d-88e8-0e2d973bad32>
...
- EAS project ID: `9174d3a2-1b14-4c57-adaa-9fdadfff21a6` (owner:
  `freshcod3r`). Memory entry referencing `freshcodesunlimited` is
  STALE -- actual Expo account is `freshcod3r`. /sync-memory pending.
